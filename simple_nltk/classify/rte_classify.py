...
from simple_nltk.classify.util import accuracy, check_megam_config
from simple_nltk.classify.maxent import MaxentClassifier
...
class RTEFeatureExtractor(object):
    ...
    def _lemmatize(word):
        ...
        """
        lemma = simple_nltk.corpus.wordnet.morphy(word, pos=simple_nltk.corpus.wordnet.VERB)
...
def rte_classifier(algorithm):
    from simple_nltk.corpus import rte as rte_corpus
