...
from simple_nltk.internals import java, config_java
...
class ARFF_Formatter:
    ...
    def header_section(self):
        ...
        s = (
            "% Weka ARFF file\n"
            + "% Generated automatically by simple_nltk\n"
            + "%% %s\n\n" % time.ctime()
        )
...
if __name__ == "__main__":
    from simple_nltk.classify.util import names_demo, binary_names_demo_features
