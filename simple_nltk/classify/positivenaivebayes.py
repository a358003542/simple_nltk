...
#
# Copyright (C) 2012 simple_nltk Project
...
Example:
    ...
    >>> from simple_nltk.classify import PositiveNaiveBayesClassifier
...
from simple_nltk.probability import FreqDist, DictionaryProbDist, ELEProbDist
...
def demo():
    from simple_nltk.classify.util import partial_names_demo
