...
from simple_nltk.internals import slice_bounds
from simple_nltk.data import PathPointer, FileSystemPathPointer, ZipFilePathPointer
from simple_nltk.data import SeekableUnicodeStreamReader
from simple_nltk.util import AbstractLazySequence, LazySubsequence, LazyConcatenation, py25
...
class PickleCorpusView(StreamBackedCorpusView):
    ...
    memory.  The following example illustrates this technique:
        ...
        >>> from simple_nltk.corpus.reader.util import PickleCorpusView
        >>> from simple_nltk.util import LazyMap
    ...
    def cache_to_tempfile(cls, sequence, delete_on_gc=True):
        ...
        """
        try:
            fd, output_file_name = tempfile.mkstemp(".pcv", "simple_nltk-")
