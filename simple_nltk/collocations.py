...
from simple_nltk.util import ngrams
...
from simple_nltk.metrics.spearman import ranks_from_scores, spearman_correlation
...
class AbstractCollocationFinder(object):
    ...
    should be provided through simple_nltk.probability.FreqDist objects or an
    identical interface.
    """
...
def demo(scorer=None, compare_scorer=None):
    ...
    from simple_nltk.corpus import stopwords, webtext
...
if __name__ == "__main__":
    import sys
    from simple_nltk.metrics import BigramAssocMeasures
