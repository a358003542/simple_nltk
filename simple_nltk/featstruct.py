...
Feature structure variables are encoded using the ``simple_nltk.sem.Variable``
...
==============================
Many of the functions defined by ``simple_nltk.featstruct`` can be applied
...
structures.
    ...
    >>> from simple_nltk.featstruct import unify
...
from simple_nltk.internals import read_str, raise_unorderable_types
...
def rename_variables(
    ...
    the same dictionary:
        ...
        >>> from simple_nltk.featstruct import FeatStruct
...
class _UnificationFailure(object):
    def __repr__(self):
        return "simple_nltk.featstruct.UnificationFailure"
