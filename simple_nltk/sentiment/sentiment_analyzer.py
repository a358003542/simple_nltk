...
using simple_nltk features and classifiers, especially for teaching and demonstrative
purposes.
"""
...
from simple_nltk.classify.util import apply_features, accuracy as eval_accuracy
...
class SentimentAnalyzer(object):
    ...
    def apply_features(self, documents, labeled=None):
        ...
        around `simple_nltk.classify.util.apply_features`.
