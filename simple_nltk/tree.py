...
from simple_nltk.grammar import Production, Nonterminal
from simple_nltk.probability import ProbabilisticMixIn
from simple_nltk.util import slice_bounds
from simple_nltk.internals import raise_unorderable_types
...
class Tree(list):
    ...
    nested Tree.
        ...
        >>> from simple_nltk.tree import Tree
    ...
    def chomsky_normal_form(
        ...
        :type  parentChar: str
        """
        from simple_nltk.treetransforms import chomsky_normal_form
    ...
    def un_chomsky_normal_form(
        ...
        :type  unaryChar: str
        """
        from simple_nltk.treetransforms import un_chomsky_normal_form
    ...
    def collapse_unary(self, collapsePOS=False, collapseRoot=False, joinChar="+"):
        ...
        :type  joinChar: str
        """
        from simple_nltk.treetransforms import collapse_unary
    ...
    def draw(self):
        ...
        """
        from simple_nltk.draw.tree import draw_trees
    ...
    def pretty_print(self, sentence=None, highlight=(), stream=None, **kwargs):
        ...
        `simple_nltk.treeprettyprinter.TreePrettyPrinter`.
        """
        from simple_nltk.treeprettyprinter import TreePrettyPrinter
    ...
    def _repr_png_(self):
        ...
        import subprocess
        import tempfile
        from simple_nltk.draw.tree import tree_to_treesegment
        from simple_nltk.draw.util import CanvasFrame
        from simple_nltk.internals import find_binary
...
def demo():
    ...
    from simple_nltk import Tree, ProbabilisticTree
