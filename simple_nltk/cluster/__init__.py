...
Usage example (see also demo())::
    from simple_nltk import cluster
    from simple_nltk.cluster import euclidean_distance
...
objects. simple_nltk_contrib.unimelb.tacohn.SparseArrays may be used for
efficiency when required.
"""

from simple_nltk.cluster.util import (
    VectorSpaceClusterer,
    Dendrogram,
    euclidean_distance,
    cosine_distance,
)
from simple_nltk.cluster.kmeans import KMeansClusterer
from simple_nltk.cluster.gaac import GAAClusterer
from simple_nltk.cluster.em import EMClusterer
