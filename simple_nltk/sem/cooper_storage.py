...
from simple_nltk.sem.logic import LambdaExpression, ApplicationExpression, Variable
from simple_nltk.parse import load_parser
from simple_nltk.parse.featurechart import InstantiateVarsChart
...
def demo():
    from simple_nltk.sem import cooper_storage as cs
