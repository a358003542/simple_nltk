...
from simple_nltk.sem.drt import (
    DRS,
...
class Boxer(object):
    ...
    def __init__(
        ...
        default is ``simple_nltkDrtBoxerDrsInterpreter``, which converts to the simple_nltk
        DRT hierarchy.
        ...
        if boxer_drs_interpreter is None:
            boxer_drs_interpreter = simple_nltkDrtBoxerDrsInterpreter()
...
class simple_nltkDrtBoxerDrsInterpreter(object):
...
if __name__ == "__main__":
    ...
    interpreter = simple_nltkDrtBoxerDrsInterpreter(occur_index=options.occur_index)
