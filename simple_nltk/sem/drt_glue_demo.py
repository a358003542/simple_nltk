...
try:
    ...
    from simple_nltk.draw.util import CanvasFrame, ShowText

except ImportError:
    """Ignore ImportError because tkinter might not be available."""

from simple_nltk.util import in_idle
from simple_nltk.tag import RegexpTagger
from simple_nltk.parse import MaltParser
from simple_nltk.sem.logic import Variable
from simple_nltk.sem.drt import DrsDrawer, DrtVariableExpression
...
class DrtGlueDemo(object):
    ...
    def about(self, *e):
        ABOUT = (
            "simple_nltk Discourse Representation Theory (DRT) Glue Semantics Demo\n"
            + "Written by Daniel H. Garrette"
        )
        TITLE = "About: simple_nltk DRT Glue Demo"
        try:
