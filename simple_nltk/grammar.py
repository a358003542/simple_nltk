...
from simple_nltk.util import transitive_closure, invert_graph
from simple_nltk.internals import raise_unorderable_types

from simple_nltk.probability import ImmutableProbabilisticMixIn
from simple_nltk.featstruct import FeatStruct, FeatDict, FeatStructReader, SLASH, TYPE
...
def cfg_demo():
    ...
    from simple_nltk import nonterminals, Production, CFG
...
def pcfg_demo():
    ...
    from simple_nltk.corpus import treebank
    from simple_nltk import treetransforms
    from simple_nltk import induce_pcfg
    from simple_nltk.parse import pchart
...
def sdg_demo():
    ...
    """
    from simple_nltk.parse import DependencyGraph
