...
from simple_nltk.tree import Tree, ProbabilisticTree
from simple_nltk.grammar import Nonterminal, PCFG

from simple_nltk.parse.api import ParserI
from simple_nltk.parse.chart import Chart, LeafEdge, TreeEdge, AbstractChartRule
...
def demo(choice=None, draw_parses=None, print_parses=None):
    ...
    """
    import sys, time
    from simple_nltk import tokenize
