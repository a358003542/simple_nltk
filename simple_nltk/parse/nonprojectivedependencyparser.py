...
class NaiveBayesDependencyScorer(DependencyScorerI):
    ...
    >>> from simple_nltk.parse.dependencygraph import DependencyGraph, conll_data2
...
class ProbabilisticNonprojectiveParser(object):
    ...
    >>> from simple_nltk.grammar import DependencyGrammar
...
def nonprojective_conll_parse_demo():
    from simple_nltk.parse.dependencygraph import conll_data2
