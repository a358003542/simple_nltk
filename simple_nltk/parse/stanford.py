...
from simple_nltk.internals import (
    find_jar_iter,
    config_java,
    java,
    _java_options,
...
class StanfordParser(GenericStanfordParser):
    ...
    def __init__(self, *args, **kwargs):
        warnings.warn(
            ...
            "Please use \033[91msimple_nltk.parse.corenlp.CoreNLPParser\033[0m instead.",
            DeprecationWarning,
            stacklevel=2,
        )
...
class StanfordDependencyParser(GenericStanfordParser):
    ...
    def __init__(self, *args, **kwargs):
        warnings.warn(
            ...
            "Please use \033[91msimple_nltk.parse.corenlp.CoreNLPDependencyParser\033[0m instead.",
            DeprecationWarning,
            stacklevel=2,
        )
...
class StanfordNeuralDependencyParser(GenericStanfordParser):
    """
    >>> from simple_nltk.parse.stanford import StanfordNeuralDependencyParser
...
@skip("doctests from simple_nltk.parse.stanford are skipped because it's deprecated")
def setup_module(module):
    ...
    try:
        ...
        raise SkipTest(
            "doctests from simple_nltk.parse.stanford are skipped because one of the stanford parser or CoreNLP jars doesn't exist"
        )
