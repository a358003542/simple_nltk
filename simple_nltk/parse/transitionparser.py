...
from simple_nltk.parse import ParserI, DependencyGraph, DependencyEvaluator
...
def demo():
    """
    >>> from simple_nltk.parse import DependencyGraph, DependencyEvaluator
    >>> from simple_nltk.parse.transitionparser import TransitionParser, Configuration, Transition
