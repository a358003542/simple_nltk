...
from simple_nltk.grammar import CFG, FeatureGrammar, PCFG
from simple_nltk.data import load

from simple_nltk.parse.chart import Chart, ChartParser
from simple_nltk.parse.pchart import InsideChartParser
from simple_nltk.parse.featurechart import FeatureChart, FeatureChartParser
...
def load_parser(
    ...
    :param grammar_url: A URL specifying where the grammar is located.
        The default protocol is ``"simple_nltk:"``, which searches for the file
        in the the simple_nltk data package.
    :type trace: int
...
def taggedsent_to_conll(sentence):
    ...
    >>> from simple_nltk import word_tokenize, pos_tag
...
def taggedsents_to_conll(sentences):
    ...
    >>> from simple_nltk import word_tokenize, simple_sent_tokenize, pos_tag
    >>> text = "This is a foobar sentence. Is that right?"
    >>> sentences = [pos_tag(word_tokenize(sent)) for sent in simple_sent_tokenize(text)]
