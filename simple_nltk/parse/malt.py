...
from simple_nltk.data import ZipFilePathPointer
from simple_nltk.internals import find_dir, find_file, find_jars_within_path

from simple_nltk.parse.api import ParserI
from simple_nltk.parse.dependencygraph import DependencyGraph
from simple_nltk.parse.util import taggedsents_to_conll
...
class MaltParser(ParserI):
    ...
    Example:
        >>> from simple_nltk.parse import malt
    ...
    def __init__(
        ...
        formatting to CONLL format. It should behave like `simple_nltk.pos_tag`
...
if __name__ == '__main__':
    """
    A demonstration function to show how simple_nltk users can use the malt parser API.

    >>> from simple_nltk import pos_tag
