...
from simple_nltk's downloader. More unified parsing models can be obtained with
...
Basic usage::
    ...
    # sudo python -m simple_nltk.downloader bllip_wsj_no_aux

    >>> from simple_nltk.data import find
...
def _scored_parse_to_simple_nltk_tree(scored_parse):
...
class BllipParser(ParserI):
    ...
    def parse(self, sentence):
        ...
        for scored_parse in nbest_list:
            yield _scored_parse_to_simple_nltk_tree(scored_parse)
...
def setup_module(module):
    ...
    try:
        ...
        raise SkipTest(
            "doctests from simple_nltk.parse.bllip are skipped because "
