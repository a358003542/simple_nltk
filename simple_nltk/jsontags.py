...
"""
Register JSON tags, so the simple_nltk data loader knows what module and class to look for.

simple_nltk uses simple '!' tags to mark the types of objects, but the fully-qualified
"tag:simple_nltk.org,2011:" prefix is also accepted in case anyone ends up
using it.
"""
