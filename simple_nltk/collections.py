...
from simple_nltk.internals import slice_bounds, raise_unorderable_types
...
class AbstractLazySequence(object):
    ...
    The most common application of lazy sequences in simple_nltk is for
...
class LazyMap(AbstractLazySequence):
    ...
    equivalent:
        ...
        >>> from simple_nltk.collections import LazyMap
        >>> function = str
        >>> sequence = [1,2,3]
...
class LazyZip(LazyMap):
    ...
    ``zip``.  In particular, an evaluated LazyZip is equivalent to a zip:
        ...
        >>> from simple_nltk.collections import LazyZip
...
class LazyEnumerate(LazyZip):
    ...
    equivalent:
        ...
        >>> from simple_nltk.collections import LazyEnumerate
...
class Trie(dict):
    ...
    def insert(self, string):
        ...
        >>> from simple_nltk.collections import Trie
        >>> trie = Trie(["abc", "def"])
