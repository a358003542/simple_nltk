...
from simple_nltk.data import show_cfg
from simple_nltk.tag import RegexpTagger
from simple_nltk.parse import load_parser
from simple_nltk.parse.malt import MaltParser
from simple_nltk.sem.drt import resolve_anaphora, AnaphoraResolutionException
from simple_nltk.sem.glue import DrtGlue
from simple_nltk.sem.logic import Expression

from simple_nltk.inference.mace import MaceCommand
from simple_nltk.inference.prover9 import Prover9Command
...
class CfgReadingCommand(ReadingCommand):
    ...
    def parse_to_readings(self, sentence):
        ...
        from simple_nltk.sem import root_semrep
...
def load_fol(s):
    """
    Temporarily duplicated from ``simple_nltk.sem.util``.
...
def discourse_demo(reading_command=None):
    ...
    background = simple_nltk.data.load(background_file)
