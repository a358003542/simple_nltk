...
from simple_nltk.inference.api import BaseProverCommand, Prover
...
class Prover9CommandParent(object):
    ...
    def print_assumptions(self, output_format="simple_nltk"):
        """
        Print the list of the current assumptions.
        """
        if output_format.lower() == "simple_nltk":
...
class Prover9Parent(object):
    ...
    It contains the functionality required to convert simple_nltk-style
    ...
    def config_prover9(self, binary_location, verbose=False):
        if binary_location is None:
            ...
            name = "prover9"
            self._prover9_bin = simple_nltk.internals.find_binary(
                name,
    ...
    def _find_binary(self, name, verbose=False):
        ...
        return simple_nltk.internals.find_binary(
            name,
