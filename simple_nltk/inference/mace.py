...
from simple_nltk.sem.logic import is_indvar
from simple_nltk.sem import Valuation, Expression

from simple_nltk.inference.api import ModelBuilder, BaseModelBuilderCommand
from simple_nltk.inference.prover9 import Prover9CommandParent, Prover9Parent
...
class MaceCommand(Prover9CommandParent, BaseModelBuilderCommand):
    ...
    def _convert2val(self, valuation_str):
        """
        Transform the output file into an simple_nltk-style Valuation.
...
def test_build_model(arguments):
    """
    Try to build a ``simple_nltk.sem.Valuation``.
    """
