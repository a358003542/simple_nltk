...
from simple_nltk.probability import ConditionalFreqDist
from simple_nltk.classify import NaiveBayesClassifier

from simple_nltk.tag.api import TaggerI, FeaturesetTaggerI
...
class DefaultTagger(SequentialBackoffTagger):
    ...
    A tagger that assigns the same tag to every token.
        ...
        >>> from simple_nltk.tag import DefaultTagger
    ...
    json_tag = "simple_nltk.tag.sequential.DefaultTagger"
...
class NgramTagger(ContextTagger):
    ...
    json_tag = "simple_nltk.tag.sequential.NgramTagger"
...
class UnigramTagger(NgramTagger):
    ...
    json_tag = "simple_nltk.tag.sequential.UnigramTagger"
...
class BigramTagger(NgramTagger):
    ...
    json_tag = "simple_nltk.tag.sequential.BigramTagger"
...
class TrigramTagger(NgramTagger):
    ...
    json_tag = "simple_nltk.tag.sequential.TrigramTagger"
...
class AffixTagger(ContextTagger):
    ...
    json_tag = "simple_nltk.tag.sequential.AffixTagger"
...
class RegexpTagger(SequentialBackoffTagger):
    ...
    of speech tag:
        ...
        >>> from simple_nltk.corpus import brown
        >>> from simple_nltk.tag import RegexpTagger
        >>> test_sent = brown.sents(categories='news')[0]
    ...
    json_tag = "simple_nltk.tag.sequential.RegexpTagger"
