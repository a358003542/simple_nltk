...
An off-the-shelf tagger is available for English. It uses the Penn Treebank tagset:
    ...
    >>> from simple_nltk import pos_tag, word_tokenize
...
the most frequent tag for *w* was in a training corpus:
    ...
    >>> from simple_nltk.tag import UnigramTagger
...
For more information, please consult chapter 5 of the simple_nltk Book.
"""

from simple_nltk.tag.api import TaggerI
from simple_nltk.tag.util import str2tuple, tuple2str, untag
from simple_nltk.tag.sequential import (
...
from simple_nltk.tag.brill import BrillTagger
from simple_nltk.tag.brill_trainer import BrillTaggerTrainer
from simple_nltk.tag.tnt import TnT
from simple_nltk.tag.hunpos import HunposTagger
from simple_nltk.tag.hmm import HiddenMarkovModelTagger, HiddenMarkovModelTrainer
from simple_nltk.tag.mapping import tagset_mapping, map_tag
from simple_nltk.tag.crf import CRFTagger
