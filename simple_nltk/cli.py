# -*- coding: utf-8 -*-
# Natural Language Toolkit: simple_nltk Command-Line Interface
#
...
from simple_nltk import word_tokenize
from simple_nltk.util import parallelize_preprocess
...
def tokenize_file(language, preserve_line, processes, encoding, delimiter):
    """ This command tokenizes text stream using simple_nltk.word_tokenize """
