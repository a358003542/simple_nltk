...
"""
This module brings together a variety of simple_nltk functionality for
...
from simple_nltk.lm import MLE
from simple_nltk.lm.preprocessing import padded_everygram_pipeline
from simple_nltk.probability import FreqDist
from simple_nltk.probability import ConditionalFreqDist as CFD
from simple_nltk.util import tokenwrap, LazyConcatenation
from simple_nltk.metrics import f_measure, BigramAssocMeasures
from simple_nltk.collocations import BigramCollocationFinder
from simple_nltk.tokenize import simple_sent_tokenize
...
class TokenSearcher(object):
    ...
    def findall(self, regexp):
        ...
        >>> from simple_nltk.text import TokenSearcher
        >>> print('hack'); from simple_nltk.book import text1, text5, text9
        hack...
        >>> text5.findall("<.*><.*><bro>")
...
class Text(object):
    ...
    >>> import simple_nltk.corpus
    >>> from simple_nltk.text import Text
    >>> moby = Text(simple_nltk.corpus.gutenberg.words('melville-moby_dick.txt'))
    ...
    def collocation_list(self, num=20, window_size=2):
        ...
        Return collocations derived from the text, ignoring stopwords.
            ...
            >>> from simple_nltk.book import text4
        ...
        if not (
            ...
            from simple_nltk.corpus import stopwords
    ...
    def readability(self, method):
        # code from simple_nltk_contrib.readability
    ...
    def dispersion_plot(self, words):
        ...
        :type words: list(str)
        :seealso: simple_nltk.draw.dispersion_plot()
        """
        from simple_nltk.draw import dispersion_plot
    ...
    def generate(self, length=100, text_seed=None, random_seed=42):
        ...
        self._tokenized_sents = [
            sent.split(" ") for sent in simple_sent_tokenize(" ".join(self.tokens))
        ]
    ...
    def plot(self, *args):
        ...
        :seealso: simple_nltk.prob.FreqDist.plot()
        """
        self.vocab().plot(*args)

    def vocab(self):
        """
        :seealso: simple_nltk.prob.FreqDist
        """
...
class TextCollection(Text):
    ...
    >>> import simple_nltk.corpus
    >>> from simple_nltk.text import TextCollection
    >>> print('hack'); from simple_nltk.book import text1, text2, text3
    hack...
    >>> gutenberg = TextCollection(simple_nltk.corpus.gutenberg)
...
def demo():
    from simple_nltk.corpus import brown
