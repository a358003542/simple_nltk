...
from simple_nltk.parse import ParserI
from simple_nltk.parse.chart import AbstractChartRule, EdgeI, Chart
from simple_nltk.tree import Tree

from simple_nltk.ccg.lexicon import fromstring, Token
...
from simple_nltk.ccg.combinator import *
from simple_nltk.ccg.logic import *
from simple_nltk.sem.logic import *

# Based on the EdgeI class from simple_nltk.
...
class CCGChartParser(ParserI):
    ...
    Based largely on the ChartParser class from simple_nltk.
    """
