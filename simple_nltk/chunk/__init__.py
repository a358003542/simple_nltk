...
from simple_nltk.chunk.util import (
    ChunkScore,
    accuracy,
    tagstr2tree,
    conllstr2tree,
...
from simple_nltk.chunk.regexp import RegexpChunkParser, RegexpParser
...
def ne_chunk(tagged_tokens, binary=False):
    """
    Use simple_nltk's currently recommended named entity chunker to
...
def ne_chunk_sents(tagged_sentences, binary=False):
    """
    Use simple_nltk's currently recommended named entity chunker to chunk the
