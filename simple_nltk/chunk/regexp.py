...
class RegexpChunkRule(object):
    ...
    def fromstring(s):
        ...
        >>> from simple_nltk.chunk.regexp import RegexpChunkRule
...
def demo():
    ...
    from simple_nltk import chunk, Tree
    ...
    from simple_nltk.corpus import conll2000
