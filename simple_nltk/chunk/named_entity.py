...
from simple_nltk.tag import ClassifierBasedTagger, pos_tag

try:
    from simple_nltk.classify import MaxentClassifier
except ImportError:
    pass
...
from simple_nltk.chunk.api import ChunkParserI
from simple_nltk.chunk.util import ChunkScore
...
class NEChunkParserTagger(ClassifierBasedTagger):
    ...
    def _english_wordlist(self):
        try:
            ...
            from simple_nltk.corpus import words
...
if __name__ == "__main__":
    ...
    from simple_nltk.chunk.named_entity import build_model
