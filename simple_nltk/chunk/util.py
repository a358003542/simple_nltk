...
from simple_nltk.tag.mapping import map_tag
...
from simple_nltk.metrics import accuracy as _accuracy
...
#
# SB: use simple_nltk.metrics for precision/recall scoring?
#
...
def demo():
    ...
    t = simple_nltk.chunk.tagstr2tree(s, chunk_label="NP")
    t.pprint()
    print()
...
"""
    ...
    print("CoNLL output:")
    print(simple_nltk.chunk.tree2conllstr(conll_tree))
    print()
