...
#
# Copyright (C) 2001-2015 simple_nltk Project
...
"""
This is a simple_nltk port of the tokenizer used in the NIST BLEU evaluation script,
...
from simple_nltk.corpus import perluniprops
from simple_nltk.tokenize.api import TokenizerI
from simple_nltk.tokenize.util import xml_unescape
...
class NISTTokenizer(TokenizerI):
    ...
    tokenization is consistent with the other tokenizers available in simple_nltk.

    >>> from simple_nltk.tokenize.nist import NISTTokenizer
    >>> nist = NISTTokenizer()
