...
The simple_nltk data package includes a pre-trained Punkt tokenizer for
English.
    ...
    ... name.
    ... '''
    >>> sent_detector = simple_nltk.data.load('tokenizers/punkt/english.pickle')
...
(from simple_nltk 3.0 onwards). It can be excluded with the realign_boundaries
flag.
