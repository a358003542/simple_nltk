...
that use pre-defined regular expressions.
    ...
    >>> from simple_nltk.tokenize import BlanklineTokenizer
    >>> # Uses '\s*\n\s*\n\s*':
...
All of the regular expression tokenizers are also available as functions:
    ...
    >>> from simple_nltk.tokenize import regexp_tokenize, wordpunct_tokenize, blankline_tokenize
...
(This is for consistency with the other simple_nltk tokenizers.)
"""
