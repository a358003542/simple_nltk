...
class Rule(TagRule):
    ...
    def format(self, fmt):
        ...
        >>> from simple_nltk.tag.brill import Pos
        ...
        Traceback (most recent call last):
          ...
          File "simple_nltk/tbl/rule.py", line 256, in format
    ...
    def _verbose_format(self):
        ...
        def range_to_str(positions):
            if len(positions) == 1:
                ...
                # for complete compatibility with the wordy format of simple_nltk2
                mx = max(positions)
                mn = min(positions)
