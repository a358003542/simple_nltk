...
from simple_nltk.tbl import error_list, Template
from simple_nltk.tag.brill import Word, Pos
from simple_nltk.tag import BrillTaggerTrainer, RegexpTagger, UnigramTagger
...
def postag(
    ...
    if templates is None:
        from simple_nltk.tag.brill import describe_template_sets, brill24
