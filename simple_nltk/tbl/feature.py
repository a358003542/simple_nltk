...
class Feature(metaclass=ABCMeta):
    ...
    json_tag = "simple_nltk.tbl.Feature"
    PROPERTY_NAME = None
    ...
    def __init__(self, positions, end=None):
        ...
        Traceback (most recent call last):
          ...
          File "simple_nltk/tbl/template.py", line 306, in __init__
            raise TypeError
    ...
    def expand(cls, starts, winlens, excludezero=False):
        ...
        >>> from simple_nltk.tag.brill import Word
        ...
        Traceback (most recent call last):
          File "<stdin>", line 1, in <module>
          File "simple_nltk/tag/tbl/template.py", line 371, in expand
